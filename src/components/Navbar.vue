        ...
        <ul
          ...
          <li>
            <router-link to="/login"
              class="block py-2 px-3 text-gray-100 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Sign
              In</router-link>
          </li>
          <li>
...
<script>
export default {
  name: 'AppNavbar', // or 'MainNavbar',
  data() {
    return {
      isNavbarOpen: false, // To track if navbar is open or closed
    };
  },
  methods: {
    toggleNavbar() {
